    ...
    return (
        <div>
            ...
            >
                <Link
                    href="/meny"
                    className="px-7 text uppercase py-2 text-black bg-white shadow-md shadow-zinc-800 hover:shadow-none hover:scale-105 rounded-md transition-all duration-300  hover:text-white hover:bg-red-600 focus:text-white focus:bg-gradient-to-b focus:from-red-700 focus:to-red-900 focus:border-white focus:border"
                >
                    Vår Meny
                </Link>
            </motion.div>
