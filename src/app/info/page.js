...
import OpningsTimes from "../../components/info/opningstimes";
            ...
            <section>
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        ...
                        <div class="from-zinc-900 via-zinc-800 to-zinc-900 border border-zinc-700 shadow-sm shadow-white rounded-lg px-4 py-8 md:p-12">
